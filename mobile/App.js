...
const styles = StyleSheet.create({
  ...
  cardTeal: { backgroundColor: '#003a32', borderColor: '#00ccb4' },
  cardMjpjay: { backgroundColor: '#003a32', borderColor: '#00ccb4' },
  cardAarogyasri: { backgroundColor: '#003a32', borderColor: '#00ccb4' },
  cardCmchis: { backgroundColor: '#003a32', borderColor: '#00ccb4' },
  cardChiranjeevi: { backgroundColor: '#003a32', borderColor: '#00ccb4' },
  cardBsky: { backgroundColor: '#003a32', borderColor: '#00ccb4' },
  healthCardHeader: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    alignItems: 'center',
